...
if BDYMN == 3 then EXY() end
if BDYMN == 4 then HOME() end
end
PUBGMH = -1
end
...
"❰  ⁦🛠️         Fix Blink 430-835       🛠️  ❱",
"❰  ⁦🛠️         Fix Blink 845-855       🛠️  ❱",
"❰  ⁦🛠️               Fix Scope              🛠️  ❱",
"❰  ⬅️            [Back - رجوع]            ⬅️  ❱",
  }, nil, "╔─━━━━━━━━░░ 👑 ░░━━━━━━━━─╗\n             ♔🔸〘 S.E sami 〙🔸♔\n🔸 Telegram ⟮ SE_2030 ⟯ للتواصل 🔸 \n╚─━━━━━━━━░░  ★ ░░━━━━━━━━─╝")
...
if WHMN == 4 then WH636() end
if WHMN == 5 then WH660() end
if WHMN == 6 then WH710() end
if WHMN == 7 then WH710() end
if WHMN == 8 then WH810() end
if WHMN == 9 then WH820() end
if WHMN == 10 then WH835() end
if WHMN == 11 then WH845() end
if WHMN == 12 then WH855() end
if WHMN == 13 then ALLD() end
if WHMN == 14 then FIXWH() end
if WHMN == 15 then FIXWH2() end
if WHMN == 16 then FIXSCOPE() end
if WHMN == 17 then BDY() end
end
PUBGMH = -1
end
...
if CLRMN845 == 2 then GREEN855() end
if CLRMN845 == 3 then YELL845() end
if CLRMN845 == 4 then BLUE855() end
if CLRMN845 == 5 then BDY() end
end
PUBGMH = -1
end
...
if CLRMN == 1 then RED625() end
if CLRMN == 2 then YELL835() end
if CLRMN == 3 then RED625() end
if CLRMN == 4 then YELL835() end
if CLRMN == 5 then WHITEALL() end
if CLRMN == 6 then BLACKALL() end
if CLRMN == 7 then RED835() end
if CLRMN == 8 then YELL835() end
if CLRMN == 9 then RED845() end
if CLRMN == 10 then GREEN855() end
if CLRMN == 11 then YELL845() end
if CLRMN == 12 then BLUE855() end
if CLRMN == 13 then GREEN855() end
if CLRMN == 14 then YELL855() end
if CLRMN == 15 then BLUE855() end
if CLRMN == 16 then WHITE855() end
if CLRMN == 17 then RED855() end
if CLRMN == 18 then BDY() end
end
PUBGMH = -1
end
...
if EXYMN == nil then else
if EXYMN == 1 then EXYWHITE() end
if EXYMN == 2 then EXYBLACK() end
if EXYMN == 3 then EXYRED() end
if EXYMN == 4 then EXY7420() end
if EXYMN == 5 then EXY7570() end
if EXYMN == 6 then EXY7870() end
if EXYMN == 7 then EXY7885() end
if EXYMN == 8 then EXY8890() end
if EXYMN == 9 then EXY8895() end
if EXYMN == 10 then EXY9810() end
if EXYMN == 11 then EXY9820() end
if EXYMN == 12 then BDY() end
end
PUBGMH = -1
end
...
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC)
gg.searchNumber("640.0;0.5;0.0;0.0:13", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
...
_CL[_FORV_3_] = "القيمة   " .. _FORV_3_ .. ""
end
_CL[last_Count] = "🔙الرجوع"
...
gg.addListItems(_A)
_FORV_3_ = _Count
elseif K_2 == _Count + 1 then EXY7420()
end
end
end
gg.setVisible(true)
...
gg.addListItems(_A)
_FORV_3_ = _Count
elseif K_2 == _Count + 1 then EXY7870()
end
end
end
gg.setVisible(true)
...
if K_2 == _Count+1 then EXY9820() end
end
end
end
gg.setVisible(true)
...
revert = gg.getResults(181, nil, nil, nil, nil, nil, nil, nil, nil)
...
gg.sleep(14)
gg.refineAddress('C0', -1, gg.TYPE_QWORD, gg.SIGN_EQUAL, 0, -1)
gg.getResults(1401)
...
if MNNOTSAFE == 1 then MAGICB() end
if MNNOTSAFE == 2 then BTRACK() end
if MNNOTSAFE == 3 then NOREC() end
if MNNOTSAFE == 4 then AIMBOT360() end
if MNNOTSAFE == 5 then SUPERJ() end
if MNNOTSAFE == 6 then FASTPARA() end
if MNNOTSAFE == 7 then KNOCKSPEED() end
if MNNOTSAFE == 8 then SITSCOPE() end
if MNNOTSAFE == 9 then SITSCOPEOFF() end
if MNNOTSAFE == 10 then HOME() end
end
PUBGMH = -1
end
